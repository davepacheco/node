  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        [ 'node_use_dtrace=="true"', {
          ...
          #
          # node_dtrace_provider.c and node_dtrace_ustack.c do not actually
          ...
          #
          'sources': [ 
            'src/node_dtrace.c', # XXX should this always be there?
            'src/node_dtrace_provider.c'
          ],
          'conditions': [ [
            'target_arch=="ia32"', {
              'sources': [ 'src/node_dtrace_ustack.c' ]
            }
          ] ],
        } ],
